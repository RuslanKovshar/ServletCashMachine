...
<div class="container mt-5" style="width: 40%">
    <form class="form-signin" method="post" action="${pageContext.request.contextPath}/api/login?redirectURI=${sessionScope.redirectURI}">
        ...
        <p>
            ...
            <input type="text" id="username" name=<%= RequestParams.EMAIL %> class="form-control"
                   placeholder="Email"
        ...
        <p>
            ...
            <input type="password" id="password" name=<%= RequestParams.PASSWORD %> class="form-control" placeholder="Password"
                   required>
        </p>
